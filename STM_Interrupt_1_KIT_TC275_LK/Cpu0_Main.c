 ...
 *
 * \name STM_Interrupt_1_KIT_TC275_LK
 * \version V1.0.2
 * \board AURIX TC275 lite Kit, KIT_AURIX_TC275_LITE, TC27xTP_D-Step
 * \keywords AURIX, Interrupt, LED, STM, STM_Interrupt_1, blink
 * \documents https://www.infineon.com/aurix-expert-training/Infineon-AURIX_STM_Interrupt_1_KIT_TC275_LK-TR-v01_00_02-EN.pdf
...
int core0_main(void)
{
    ...
    initTask_Cpu0();    // Register the 3 tasks
    startTask_Cpu0();
